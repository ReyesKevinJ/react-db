...
const URI = 'http://localhost:8000/blogs/login'
...
const CompLogin = () =>{
    ...
    const store = async (e) =>{
        e.preventDefault()
        await axios.post(URI,{user:user,pass:pass})
        // navigate('/')
    }
    return(
        <div className='container'>
            ...
            <form onSubmit={store}>
                <div className="mb-6">
                    <label for="user" className="block mb-2 text-sm font-medium text-gray-900 ">Your User</label>
                ...
                <div class="mb-6">
                    <label for="pass" class="block mb-2 text-sm font-medium text-gray-900">Your password</label>
